    ...
    public partial class CreateNewSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeyParamses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KeyParamses_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KeyParamses_Words_KeyWordsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeyParamses_KeyWordsId",
                table: "KeyParamses",
                column: "KeyWordsId");

            migrationBuilder.CreateIndex(
                name: "IX_KeyParamses_ProductId",
                table: "KeyParamses",
                column: "ProductId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Orders_Name_AlterId", x => new { x.Name, x.AlterId });
                });
        }
    }
}
